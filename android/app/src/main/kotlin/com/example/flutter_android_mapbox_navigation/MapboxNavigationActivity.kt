...
import com.example.flutter_android_mapbox_navigation.databinding.ActivityMainBinding
import com.mapbox.android.core.permissions.PermissionsListener
import com.mapbox.android.core.permissions.PermissionsManager
import com.mapbox.navigation.examples.preview.MapboxExamplesAdapter
import com.mapbox.navigation.examples.preview.examplesList


class MapboxNavigationActivity : AppCompatActivity(), PermissionsListener {
    ...
    private fun bindExamples() {
        ...
        examplesAdapter = MapboxExamplesAdapter(examples) {
            startActivity(Intent(this@MapboxNavigationActivity, examples[it].activity))
        }
